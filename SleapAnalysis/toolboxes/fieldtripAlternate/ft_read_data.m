...
switch dataformat
  ...
  case 'neuroscope_bin'
    ...
    dat     = LoadBinary(filename, 'frequency', hdr.Fs, 'offset', begsample-1, 'nRecords', endsample-begsample+1, 'nChannels', hdr.orig.nChannels, 'channels', chanindx, 'precision', precision).';
